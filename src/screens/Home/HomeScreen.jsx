    ...
    <>
      ...
      <View className="flex-1 bg-white">
        <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          ...
          <View
            className="flex-row justify-between items-center bg-[#4CAF50]"
            style={{
              paddingTop: insets.top,
              paddingHorizontal: scale(10), // optional for left/right spacing
          ...
          >
            <View className="flex-row items-center space-x-3">
              ...
              <View className="ml-2">
                <Text
                  className="font-PopinsRegular color-[#F3F4F6]"
                  style={{ fontSize: scale(18) }}
                >
                  Golf Buddy Club
                </Text>
                <Text
                  className="color-[#F3F4F6] font-PopinsRegular"
                  style={{
                    fontSize: scale(14),
            ...
            >
              ...
              >
                ...
                >
                  ...
                  compatible matches for today. Your skill level and playing
                  style are perfect for afternoon rounds.
                </Text>
              </View>
